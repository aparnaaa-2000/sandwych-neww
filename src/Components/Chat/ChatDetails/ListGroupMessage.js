                        ...
                        return (
                            ...
                            <ScrollView showsVerticalScrollIndicator={false}>
                                ...
                                <View style={[styles.viewEnd, {
                                    alignSelf: itemId == item?.sender_id ?
                                        'flex-end' : 'flex-start'
                                }]} >

                                    <View style={{ flexDirection: 'row', justifyContent: 'center' }}>

                                        {itemId !== item?.sender_id &&
                                            <View>
                                                <FastImage
                                                    style={styles.imageV}
                                                    source={{
                                        ...
                                        {item.type !== "text" ?
                                            <View style={{
                                                ...
                                                {DeleteId == item.id &&
                                                    <TouchableOpacity onPress={() => setModalOpen(true)} style={{ top: 10 }}>
                                                ...
                                                {/* {itemId !== item?.sender_id &&
                                                    <TouchableOpacity onPress={() => DeleteMessage()} style={{ top: 10 }}>
                                                        <BlackDelete width={25} height={25} />
                                                    </TouchableOpacity>} */}
