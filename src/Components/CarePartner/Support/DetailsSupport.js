...
import { BACKGROUNDGREY, BORDERCOLOR5, PUREBLACK, TEXTCOLOR10, TEXTCOLOR5, PUREWHITE, PRIMARYCOLOR, BORDERCOLORSUPPORT, PLACEHOLDERCOLOR1, PLACEHOLDERCOLOR3 } from '../../../Constants/Colors/Colors'
import { FONTS } from '../../../Constants/Fonts'
import { fontSize, GlobalSize } from '../../../Constants/ResponsiveFont/ResponsiveFonts'

const DetailsSupport = ({ item,supportName }) => {
    

    return (
        <>
            <View style={{ marginBottom: 5 }}>
                <Text style={[styles.textRes, { fontSize: 20 }]}>{supportName}</Text>
            </View>
            ...
            <View style={styles.viewDetails}>
                ...
                <View>
                    <Text style={styles.textDetails}>{item?.phonenumber}</Text>
                </View>
            </View>
            ...
            <View style={styles.viewDetails}>
                ...
                <View style={{ maxWidth: DEFAULTWIDTH * 0.5 }}>
                    <Text style={styles.textDetails}>{item?.address}</Text>
                </View>


            </View>

{item?.support_member_professional_details[0]?.individualcaqh &&
            <View style={styles.viewDetails}>
...
{item?.support_member_professional_details[0]?.individualnpi &&
            <View style={styles.viewDetails}>
            ...
            {item?.support_member_professional_details[0]?.practicenpi &&
            <View style={styles.viewDetails}>
            ...
            <ScrollView horizontal showsHorizontalScrollIndicator={false}>
                {item?.all_schedules?.map((i, index) => {
                    return (
        ...
        {item?.validated_data?.note &&
            <View style={styles.borderView}>
                ...
                <View>
                    <Text style={styles.textDesc}>{item?.validated_data?.note}</Text>
                </View>
            </View>}
        </>
    )
