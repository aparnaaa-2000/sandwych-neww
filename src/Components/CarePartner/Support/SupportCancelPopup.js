...
const SupportCancelPopup = ({ModalOpen, setModalOpen, navigation,OnSupportCancel}) => {
      ...
      <View style={styles.mainContainer}>
        <View style={styles.viewMain}>
          <View
            ...
            <Text style={styles.textQuest}>Are you sure you want to cancel this request?</Text>
          </View>
...
export default SupportCancelPopup;
