...
const SupportListIADL = ({ data, Title }) => {

    const functionalAbilities1 = data?.filter(item => item.functional_abilities === '0')

  const renderItem = ({ item }) => {

    return (
      <View>
        {item.functional_abilities ==  '0' &&
...
export default SupportListIADL;
