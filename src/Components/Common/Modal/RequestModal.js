...
import useNearByRequest from '../../../hooks/apihooks/useNearbyRequest';

const RequestModal = ({ModalOpen, setModalOpen, navigation, title , rejected_request_id}) => {
  ...
  const handleRequest = async () => {
    ...
    try {
      const responce = await useNearByRequest(data);
      setResult(responce);
      console.log('RESULT_NAVIGATION...', responce);
