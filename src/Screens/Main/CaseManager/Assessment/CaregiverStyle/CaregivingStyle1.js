    ...
    return (
        <SafeAreaView style={DEFAULTSTYLES.AndroidSafeArea}>
            ...
            <View style={{ padding: GlobalSize(20),paddingTop:GlobalSize(5) }}>
                ...
                <View>
                    <Text style={styles.textSub}>Which of the following health challenges affect [care recipient name]?</Text>
                </View>
            </View>
...
export default CaregivingStyle1
