        ...
        return (
            <SafeAreaView style={DEFAULTSTYLES.AndroidSafeArea}>
                ...
                <ScrollView showsVerticalScrollIndicator={false} style={{ marginBottom: GlobalSize(85) }}>
                    <View>
                        ...
                        <View>
                            ...
                            <View style={styles.imageView}>
                                <Image
                                    source={require('../../../../../../assets/Images/SocialWorker/bag.png')}
                                    style={{ width: GlobalSize(20), height: GlobalSize(20) }} resizeMode='contain'/>
                                <Text style={styles.textTitle}>Empty Catheter or Ostomy bag</Text>
                            </View>
                        ...
                        <View>
                            <View style={styles.imageView}>
                                <Image
                                    source={require('../../../../../../assets/Images/SocialWorker/inject.png')}
                                    style={{ width: GlobalSize(20), height: GlobalSize(20) }} />
                                <Text style={styles.textTitle}>Giving medicines like eyedrops, injections</Text>
                            </View>
                        </View>
                        ...
                        <View style={styles.imageView}>
                            <Image
                                source={require('../../../../../../assets/Images/SocialWorker/diet.png')}
                                style={{ width: GlobalSize(20), height: GlobalSize(20) }} resizeMode='contain' />
                            <Text style={styles.textTitle}>Prepping food for special diets</Text>
                        </View>
                    ...
                    <View style={styles.imageView}>
                        <Image
                            source={require('../../../../../../assets/Images/SocialWorker/tube.png')}
                            style={{ width: GlobalSize(20), height: GlobalSize(20) }} resizeMode='contain'/>
                        <Text style={styles.textTitle}>Tube Feedings</Text>
                    </View>
                    ...
                    <View style={styles.imageView}>
                        <Image
                            source={require('../../../../../../assets/Images/SocialWorker/blood.png')}
                            style={{ width: GlobalSize(20), height: GlobalSize(20) }} resizeMode='contain' />
                        <Text style={styles.textTitle}>Skin tear or wound care</Text>
                    </View>
                    ...
                    <View style={styles.imageView}>
                        <Image
                            ...
                            style={{ width: GlobalSize(20), height: GlobalSize(20) }} />
                        <Text style={styles.textTitle}>Monitoring Blood Pressure</Text>
                    </View>
