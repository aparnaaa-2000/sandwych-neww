...
const AbilityToHelp = ({ navigation }) => {
    ...
    return (
        <SafeAreaView style={{ backgroundColor: BACKGROUNDWHITE, flex: 1 }}>
            ...
            <View style={DEFAULTSTYLES.margin}>
                ...
                <Text style={styles.subHeader1}>You indicated you needed support for the following, who helps you currently?</Text>
            </View>
            <View style={styles.container}>

                <View>
                    <Text style={styles.subHeader}>Getting Dressed</Text>
                    <Dropdown
                        style={styles.textIn}
                ...
                <View style={{ marginTop: 5 }} >
                    <Text style={styles.subHeader}>Getting to and from the toilet</Text>
                ...
                <View style={{ marginTop: 5 }}>
                    <Text style={styles.subHeader}>Feeding</Text>
                    <Dropdown
                        style={styles.textIn}
                        placeholderStyle={styles.placeholderS}
                        itemTextStyle={styles.textArea}
                ...
                <View style={{ marginTop: 5 }}>
                    <Text style={styles.subHeader}>Helping with Incontinence</Text>
                    <Dropdown
                        style={styles.textIn}
                        placeholderStyle={styles.placeholderS}
                        itemTextStyle={styles.textArea}
