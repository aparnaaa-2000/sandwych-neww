...
import {RegisterSupport} from '../../../../../redux/supportthunk';
import { supportregisterClear } from '../../../../../redux/Slice/SupportMember/SupportRegisterSliceKey';

const SupportMemberForm = ({navigation, route}) => {
  ...
  const {data, error, isLoading, data1} = useSelector(
    state => ({
      data: state.supportregister.data,
      error: state.supportregister.error,
      isLoading: state.supportregister.isLoading,
  ...
  const handleEmailChange = text => {
    const isValidEmail =
      /^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Z|a-z]{2,}$/.test(text);
  ...
  const OnValidation = () => {
    ...
    const result = selectedRoles.map(selectedRole => ({id: selectedRole}));
    ...
    //An identifier should be shared instead of the email.
    RegisterSupport(
      Role,
      Email,
      Name,
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <View style={styles.mainContainer}>
            <View style={{marginBottom: DEFAULTWIDTH * 0.07}}>
              <Text style={styles.headingText}>Support Member</Text>
            ...
            {/* <View style={styles.inputTextViewStyle}>
              ...
              {!CodeStatus && (
                <Text style={{color: VALIDCOLOR, top: GlobalSize(5)}}>
                  Code is required
                </Text>
              )}
              ...
              {TooltipOpen && (
                <View style={styles.viewTooltip}>
                  <Text style={styles.textDesc}>
                    This is an invitation code recieved when a patient is
                    requests you to add as their Care Partner.
                  </Text>
                </View>
              )}
            </View> */}
            ...
            <View style={styles.inputTextViewStyle}>
              ...
              {!NameStatus && (
                <Text style={{color: VALIDCOLOR, top: 5}}>
                  Name is required
                </Text>
              )}
            </View>
              ...
              <View style={styles.inputTextViewStyle}>
                ...
                <TextInput
                  ...
                  style={[
                    styles.textInputStyle,
                    {
                      borderColor: !ZipcodeStatus ? VALIDCOLOR : BORDERCOLOR4,
                  ...
                  <View style={{flexDirection: 'row'}}>
                    <TouchableOpacity
                      ...
                      <View
                        style={[
                          styles.radioIcon,
                          selectedOption == 'Male' && styles.radioIconSelected,
                        ]}>
                        {selectedOption == 'Male' && (
              ...
              <View
                style={[
                  styles.textInputStyle,
                  {
                    flexDirection: 'row',
                    justifyContent: 'space-between',
                    borderColor: DOBStatus ? VALIDCOLOR : BORDERCOLOR4,
                  },
                ]}>
                <TextInput
                  value={DOB}
            ...
            <View style={styles.inputTextViewStyle}>
              {/* Languages should be multiselect from multiple */}
              ...
              {/* <View>
                <Dropdown
                  style={[
                    styles.textIn,
                    {borderColor: RelationStatus ? VALIDCOLOR : BORDERCOLOR1},
                  ]}
...
export default SupportMemberForm;
